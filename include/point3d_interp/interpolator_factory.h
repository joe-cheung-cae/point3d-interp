#ifndef POINTER3D_INTERP_INTERPOLATOR_FACTORY_H
...
private:
     ...
     */
    std::unique_ptr<IInterpolator> createStructuredInterpolator(
        InterpolationMethod method,
        const std::vector<Point3D>& coordinates,
        const std::vector<MagneticFieldData>& fieldData,
        ExtrapolationMethod extrapolation,
     ...
     */
    std::unique_ptr<IInterpolator> createUnstructuredInterpolator(
        InterpolationMethod method,
        const std::vector<Point3D>& coordinates,
        const std::vector<MagneticFieldData>& fieldData,
        ExtrapolationMethod extrapolation,
     ...
     */
    static bool isRegularGrid(const std::vector<Point3D>& coordinates,
                              const std::vector<MagneticFieldData>& fieldData,
...
#endif  // POINTER3D_INTERP_INTERPOLATOR_FACTORY_H