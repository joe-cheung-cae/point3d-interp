...
static void BM_HMLS_InsideDomain_1000(benchmark::State& state) {
    // Generate test data
    ...
    state.SetLabel("HMLS 1000 data points, 1000 queries");
}

BENCHMARK(BM_HMLS_InsideDomain_1000)->Unit(benchmark::kMillisecond);
