...
/**
 * @brief Performance benchmark for structured data with 27,000 points (outside domain)
 */
class BenchmarkStructuredOutsideDomain27000 : public p3d::BenchmarkBase {
  protected:
...
int main() {
    BenchmarkStructuredOutsideDomain27000 benchmark;
