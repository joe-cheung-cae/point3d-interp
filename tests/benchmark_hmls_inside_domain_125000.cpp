...
static void BM_HMLS_InsideDomain_125000(benchmark::State& state) {
    // Generate test data
    const size_t num_data_points = 125000;
    ...
    state.SetLabel("HMLS 125000 data points, 1000 queries");
}

BENCHMARK(BM_HMLS_InsideDomain_125000)->Unit(benchmark::kMillisecond);
