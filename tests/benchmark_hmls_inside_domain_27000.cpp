...
static void BM_HMLS_InsideDomain_27000(benchmark::State& state) {
    // Generate test data
    const size_t num_data_points = 27000;
    ...
    state.SetLabel("HMLS 27000 data points, 1000 queries");
}

BENCHMARK(BM_HMLS_InsideDomain_27000)->Unit(benchmark::kMillisecond);
