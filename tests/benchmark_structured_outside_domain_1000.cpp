...
/**
 * @brief Performance benchmark for structured data with 1,000 points (outside domain)
 */
class BenchmarkStructuredOutsideDomain1000 : public p3d::BenchmarkBase {
  protected:
...
int main() {
    BenchmarkStructuredOutsideDomain1000 benchmark;
