...
/**
 * @brief Performance benchmark for structured data with 8,000 points (outside domain)
 */
class BenchmarkStructuredOutsideDomain8000 : public p3d::BenchmarkBase {
  protected:
...
int main() {
    BenchmarkStructuredOutsideDomain8000 benchmark;
